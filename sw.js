...
const PRECACHE = [
  ...
  '/pages/hospedagem-com-pontos.html',
  '/pages/lojas.html',
  '/pages/cruzeiros.html',
  '/pages/saude.html',
  '/pages/cartoes.html',
  ...
  '/pages/idiomas.html',
  '/pages/poses.html',
  '/pages/europa-perfeita.html',
  '/pages/passo-a-passo.html',
  '/pages/apps-na-viagem.html',
  '/js/poses.js',
  '/js/poses-dados.js',
  '/js/roteiros.js',
  '/js/trens.js',
